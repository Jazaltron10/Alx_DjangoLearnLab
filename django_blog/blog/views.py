...
class CommentUpdateView(LoginRequiredMixin, UserPassesTestMixin, UpdateView):
    ...
    def get_context_data(self, **kwargs):
        context = super().get_context_data(**kwargs)
        context['post'] = self.object.post  # Assuming Comment model has a ForeignKey to Post
        return context
    
    def get_success_url(self):
        return reverse('post-detail', kwargs={'pk': self.object.post.pk})  # Redirect to post detail after updating comment
